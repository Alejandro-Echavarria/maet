        ...
        <DialogModal :show="modal" :maxWidth="'2xl'" @close="closeModal">
            ...
            <template #content>
                <div class="mt-4">
                    ...
                    <v-select class="mt-3 style-chooser"
                        :options="['Canada', 'United States', 'United States2', 'United States34', 'United States4', 'United States4', 'United States4', 'United States4']"
