...
<template>
    <div>
        ...
        <div class="space-y-6 max-w-5xl mx-auto">
            <h1 :class="`text-5xl lg:text-7xl py-1.5 md:text-6xl font-bold bg-gradient-to-r from-${job.color} via-gray-800/90 to-gray-800 bg-clip-text text-transparent animate-fade-in-left`"
